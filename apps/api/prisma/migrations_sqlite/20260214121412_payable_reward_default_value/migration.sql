...
INSERT INTO "new_Sub" ("archive", "attractorId", "epg", "externalId", "id", "login", "note", "playlist", "pwd", "secondarySubsAmount", "stalkerPortal", "totalPayableReward", "userId") SELECT "archive", "attractorId", "epg", "externalId", "id", "login", "note", "playlist", "pwd", "secondarySubsAmount", "stalkerPortal", "totalPayableReward", "userId" FROM "Sub";
DROP TABLE "Sub";
