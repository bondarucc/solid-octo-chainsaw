...
export type ReplaceDatesWithStringsRecursively<T> = {
  [K in keyof T]: T[K] extends {} ? ReplaceDatesWithStringsRecursively<T[K]> : Date extends T[K] ? Exclude<T[K], Date> | string : T[K]
}
